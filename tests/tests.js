...
describe("fixture (with promises)", function () {
  it("should load fixture without id", function () {
    return sf
      .loadFixture(FOO_FIXTURE, models, options)
      .then(function () {
  ...
  it("should load fixtures from json", function () {
    return sf
      .loadFile("tests/fixtures/fixture1.json", models, options)
      .then(function () {
        return models.Foo.count();
      })
      .then(function (c) {
  ...
  it("should load fixtures from js (implied relative)", function () {
    return sf
      .loadFile("tests/fixtures/fixture1.js", models)
      .then(function () {
        return models.Foo.count();
      })
      .then(function (c) {
  ...
  it("should load fixtures from js (absolute)", function () {
    return sf
      .loadFile(process.cwd() + "/tests/fixtures/fixture1.js", models)
      .then(function () {
        return models.Foo.count();
      })
      .then(function (c) {
  ...
  it("should load fixtures from multiple files via glob", function () {
    return sf
      .loadFile("tests/fixtures/fixture*.json", models)
      .then(function () {
        return models.Foo.count();
      })
      .then(function (c) {
  ...
  it("should load fixtures from multiple files", function () {
    return sf
      .loadFiles(
        ["tests/fixtures/fixture1.json", "tests/fixtures/fixture2.json"],
        models
      )
      .then(function () {
        return models.Foo.count();
  ...
  it("should load yaml fixtures", function () {
    return sf
      .loadFile("tests/fixtures/fixture3.yaml", models)
      .then(function () {
        return models.Foo.count();
      })
      .then(function (c) {
  ...
  it("should throw errors if files are missing", function () {
    return sf
      .loadFile("tests/fixtures/fixture_that_does_not_exist.json", models)
      .catch(function (err) {
        err.message.should.equal(
          "No files matching 'tests/fixtures/fixture_that_does_not_exist.json' found."
        );
      });
  });
  ...
  it("should load assosication with. natural keys", function () {
    return sf
      .loadFile("tests/fixtures/natkeys.yaml", models)
      .then(function () {
  ...
  it("should load assosication with. ids", function () {
    return sf
      .loadFile("tests/fixtures/associd.yaml", models)
      .then(function () {
        return models.Foo.findAll();
      })
      .then(function (foos) {
  ...
  it("should load many2many assocs by nat keys", function () {
    return sf
      .loadFile("tests/fixtures/many2manynatural.yaml", models)
      .then(function () {
  ...
  it("should load belongs 2 many assocs by nat keys", function (done) {
    sf.loadFile("tests/fixtures/many2manynatural.yaml", models).then(
      function () {
  ...
  it("should load many2many assocs by ids", function () {
    return sf
      .loadFile("tests/fixtures/many2manyid.yaml", models)
      .then(function () {
        return models.Project.findOne({
          where: {
  ...
  it('should handle primary keys not named "id" for has many', function () {
    return sf
      .loadFile("tests/fixtures/custompk.yaml", models)
      .then(function () {
  ...
  it("if transaction specified, it should be passed to models", function (done) {
    ...
    models.sequelize
      .transaction(function (t) {
        FooMock.expects("findOne")
          .once()
          .returns(findDeferred.promise)
          .withExactArgs({
            where: data,
            transaction: t,
          });
  ...
  it("should load fixtures and then transform their values", function () {
    return sf
      .loadFile("tests/fixtures/fixture1.json", models, {
  ...
  it("should add attributes to many2many through table", function () {
    return sf
      ...
      .then(function (movies) {
        ...
        should.exist(movies[0].actorMovie.character);
        movies[0].actorMovie.character.should.equal("T-80");
      });
  });

  it("should perform a set operation if one exists", function () {
    return sf
      .loadFile("tests/fixtures/serializedJsonFixture.js", models)
      .then(function () {
  ...
  it("should exclude VIRTUAL columns from filter condition", function () {
    return sf
      .loadFile("tests/fixtures/virtual.js", models)
      .then(function () {
  ...
  it("should handle json including arrays", function () {
    return sf
      .loadFile("tests/fixtures/jsonContainingArray.js", models)
      .then(function () {
