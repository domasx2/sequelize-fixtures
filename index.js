...
function wrap(fn) {
  return function () {
    if (arguments.length < 2) {
      ...
      if (cb) {
        console.warn(
          "Sequelize-fixtures: callback arguments are deprecated, please use returned promises."
        );
        promise
          .then(
            function () {
...
exports.loadFixtures = wrap(function (fixtures, models, options) {
  ...
  return loader.loadFixtures(fixtures, models).then(function (result) {
    ...
    return writer
      .writeFile(options.referenceFile, loader.reference)
      .then(function () {
        return result;
      });
  });
